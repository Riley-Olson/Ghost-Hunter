...
/*  Function:  initBuilding
    Purpose:   initialize the building
       in:   pointer to a BuildingType object
*/
...
void populateRooms(BuildingType *building) {
    ...
    connectRooms(van_node, hallway_node);
    connectRooms(hallway_node, master_bedroom_node);
    connectRooms(hallway_node, boys_bedroom_node);
    connectRooms(hallway_node, bathroom_node);
    connectRooms(hallway_node, kitchen_node);
    connectRooms(hallway_node, basement_node);
    connectRooms(basement_node, basement_hallway_node);
    connectRooms(basement_hallway_node, right_storage_room_node);
    connectRooms(basement_hallway_node, left_storage_room_node);
    connectRooms(kitchen_node, living_room_node);
    connectRooms(kitchen_node, garage_node);
    connectRooms(garage_node, utility_room_node);
}
